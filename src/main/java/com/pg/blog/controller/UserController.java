...
import com.pg.blog.model.KakaoProfile;
import com.pg.blog.model.OAuthToken;
import com.pg.blog.model.User;
import com.pg.blog.service.UserService;

// 인증이 안된 사용자들이 출입할 수 있는 경로를 /auth/** 허용
// s그냥 주소가 / 이면 index.jsp 허용
...
public class UserController {
	...
	public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
		...
		final String client_id = "e572a1fa1f764f4b73334734acdd0ec5";
		final String redirect_uri = "http://localhost:8081/auth/kakao/callback";
		...
		//UUID는 중복되지않는 어떤 특정값을 만들어내는 알고리즘
		...
		//회원찾기
		User originUser  = userService.findUser(kakaoUsername);
		
		if(originUser.getUsername() == null) {
			System.out.println("기존회원이아니기에 자동으로 회원가입진행합니다.");
			userService.userJoin(kakaoUser);
		}
		
		System.out.println("자동로그인합니다.");
		//로그인처리
